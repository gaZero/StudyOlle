...
public class QEnrollment extends EntityPathBase<Enrollment> {
    ...
    private static final long serialVersionUID = -1336642629L;
    ...
    public final com.studyolle.modules.account.QAccount account;
    ...
    public QEnrollment(Class<? extends Enrollment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.account = inits.isInitialized("account") ? new com.studyolle.modules.account.QAccount(forProperty("account")) : null;
