...
public class QEvent extends EntityPathBase<Event> {
    ...
    private static final long serialVersionUID = 1906674563L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QEvent event = new QEvent("event");

    public final com.studyolle.modules.account.QAccount createdBy;
    ...
    public final com.studyolle.modules.study.QStudy study;
    ...
    public QEvent(Class<? extends Event> type, PathMetadata metadata, PathInits inits) {
        ...
        this.createdBy = inits.isInitialized("createdBy") ? new com.studyolle.modules.account.QAccount(forProperty("createdBy")) : null;
        this.study = inits.isInitialized("study") ? new com.studyolle.modules.study.QStudy(forProperty("study")) : null;
    }
